...
//CONFIGURAR ESTE ESPACIO
	...
	$basededatos = "id19335296_ashen";   // Nombre de la base de datos (¡Las mayusculas IMPORTAN!)
	$usuariodb 	 = "id19335296_ashenk";    		// Nombre del usuario administrador de la base de datos
	$clavedb 	 = "oBjbXfMJ&oBYwa7@";    			// Clave para acceder a la base de datos.
